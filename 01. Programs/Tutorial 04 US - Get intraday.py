...
def stockPriceIntraday(ticker, folder):
    ...
    url = 'https://www.alphavantage.co/query?apikey=NGV2US07ZZQULVGP&function=TIME_SERIES_INTRADAY&symbol={ticker}&interval=1min&outputsize=full&datatype=csv'.format(
        ticker=ticker)
...
tickersRawData = dataframeFromUrl(
    'http://old.nasdaq.com/screening/companies-by-industry.aspx?exchange=NASDAQ&render=download')
...
stockPriceIntraday('NVDA', folder='../02. Data/01. IntradayUS')
time.sleep(2)
